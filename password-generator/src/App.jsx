      ...
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8
       text-orange-400 bg-gray-800'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          <input type="text"
            value={password} className='outline-none text-gray-500 w-full py-1 px-3 bg-gray-50'
            placeholder='Password' readOnly ref={passwordRef} />

          <button className='outline-none bg-violet-700 text-white px-3 py-0.5 hover:bg-violet-600 hover:cursor-pointer
          shrink-0' onClick={copyPasswordToClipboard}>Copy
          </button>
        </div>
